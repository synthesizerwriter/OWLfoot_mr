...
The OWL pedal from Rebel Technology is a guitar 'stomp' box with a difference - you can program the micro controller inside it to run any of over 200 'patches', ranging from the delays and flanging that you would expect, to more unusual devices like sound generators, step sequencers and more...
